...
public class CovoiturageBdeBConfiguration {
    ...
    CommandLineRunner ajouterQuatresConducteurs() {
        return args -> {
            Conducteur conducteur1 = new Conducteur("Houas", "Yosra", "5184 Rue Desmarteau", "5145492221", "houas_yora@hotmail.fr", "password", "conducteur", "Audi A4", 3, "audiA4.png", "Hou150891");
            Conducteur conducteur2 = new Conducteur("Afshar Ghasemloo", "Saba", "Boulevard Laval, Laval-des-rapides, Laval, QC", "5145492221", "saba@gmail.com", "password", "conducteur", "bmwX5", 3, "bmwX5.png", "AFS202306");
            Conducteur conducteur3 = new Conducteur("Albornoz Luna", "Roger", "Jean Talon Market, Avenue Henri-Julien, Montréal, QC", "5145492221", "roger@gmail.com", "password", "conducteur", "Range Rover", 4, "rangRover.png", "ROG010523");
            Conducteur conducteur4 = new Conducteur("Ngondo", "Chantal", "Boulevard Langelier, Saint-Léonard, QC", "5145492221", "chantal@gmail.com", "password", "conducteur", "Toyota", 3, "toyota.png", "NGC202306");
    ...
    CommandLineRunner ajouterListeTrajetsConducteur1() {
        return args -> {
            ...
            if (conducteur != null) {
                ...
                // Les date de trajet
                Date dateTrajet1 = format.parse("2023-06-05");
                Date dateTrajet2 = format.parse("2023-06-06");
                Date dateTrajet3 = format.parse("2023-06-07");
    ...
    CommandLineRunner ajouterListeTrajetsConducteur2() {
        return args -> {
            ...
            if (conducteur != null) {
                ...
                // Les date de trajet
                Date dateTrajet1 = format.parse("2023-06-05");
                Date dateTrajet2 = format.parse("2023-06-08");
    ...
    CommandLineRunner commandLineRunnerpourConducteur3() {
        return args -> {
            ...
            if (conducteur != null) {
                ...
                SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
                // Les date de trajet
                Date dateTrajet1 = format.parse("2023-06-12");
                Date dateTrajet2 = format.parse("2023-06-13");
    ...
    CommandLineRunner commandLineRunnerpourConducteur4() {
        return args -> {
            ...
            if (conducteur != null) {
                ...
                SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
                // Les date de trajet
                Date dateTrajet1 = format.parse("2023-06-07");
                Date dateTrajet2 = format.parse("2023-06-16");
